...
func Test_ExecuteStats(t *testing.T) {
	...
	rootCmd.SetArgs([]string{"stats", "../cldf/testdata/StructureDataset-metadata.json"})
	rootCmd.Execute()
	...
	rootCmd.SetArgs([]string{"stats", "../cldf/testdata/StructureDataset-metadata.json", "--metadata"})
	rootCmd.Execute()
